        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableQuantity = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    UnitPrice = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    Unit = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Category = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ReorderLevel = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Length = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    ...
                    PaperType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    PrintingType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    PricePerBox = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerProducts_CustomerId_ProductName",
                table: "CustomerProducts",
                columns: new[] { "CustomerId", "ProductName" },
                unique: true);
