// Box Calculator Results Display Functions
...
function displayResults(result) {
    const html = `
        ...
        <!-- Cost Breakdown Table - ENHANCED with Per Sheet & Per Box -->
        <div class="card">
            <div class="card-header breakdown-header">
                ...
                <table class="breakdown-table table table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.paper1CostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.paper2CostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td>Medium (Flute)</td>
                            <td class="text-center">Rs./kg</td>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.mediumCostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr class="table-active">
                            ...
                            <td class="text-right"><strong>Rs. ${(result.costBreakdown.totalMaterialCostPerBox * result.quantity).toFixed(2)}</strong></td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.wastageCost * result.quantity).toFixed(2)}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.printingCostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td>Die Cutting</td>
                            <td class="text-center">Rs./sheet</td>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.dieCuttingCostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td>Labor</td>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.laborCostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td>Pin Cost</td>
                            <td class="text-center">Rs./box</td>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.pinCostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr>
                            <td>Transport</td>
                            <td class="text-center">Rs./box</td>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.transportCostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        ...
                        <tr class="table-active">
                            ...
                            <td class="text-right"><strong>Rs. ${(result.costBreakdown.subtotalPerBox * result.quantity).toFixed(2)}</strong></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.overheadCostPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr class="table-active">
                            ...
                            <td class="text-right"><strong>Rs. ${(result.costBreakdown.totalCostPerBox * result.quantity).toFixed(2)}</strong></td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.profitPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr class="table-success">
                            ...
                            <td class="text-right"><strong>Rs. ${(result.costBreakdown.sellingPricePerBox * result.quantity).toFixed(2)}</strong></td>
                        </tr>
                        <tr>
                            <td>GST (18%)</td>
                            <td class="text-center">%</td>
                            ...
                            <td class="text-right">Rs. ${(result.costBreakdown.gstAmountPerBox * result.quantity).toFixed(2)}</td>
                        </tr>
                        <tr class="table-primary">
                            ...
                            <td class="text-right"><strong>Rs. ${result.totalOrderValueWithGST.toLocaleString('en-IN', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p><strong>Total Order Value:</strong> Rs. ${result.totalOrderValueWithGST.toLocaleString('en-IN', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</p>
                    </div>
                </div>
            </div>
        </div>
